...
$(document).ready(function(){
	...
	function visual_Slides(_targetWrap, _slides, _has_pause, _type){
		...
		function fade_img(num){
			$slides.fadeOut(1000);
			$slides.eq(num).fadeIn(1000);
			$("section.movie_li").css("background", "url('images/bg_movie_movie_0"+ (num + 1) +".jpg') no-repeat center center").css("background-size", "cover");
		}
	...
	var two_slide_01 = visual_Slides(".li_visual", ".slides", false, "fade");
