...
$(document).ready(function(){
	...
	function rolling_slide(_targetWrap, _view_ea_D, _view_ea_T, _view_ea_M){
		...
		var $btn_prev = $($wrap +" button.prev_w");
		var $btn_next = $($wrap +" button.next_w");
	...
	var rolling_slide_01 = rolling_slide(".movie_li", 1, 1, 1);
